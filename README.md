...
| 🧭 **North Reference** | Automatic / True North / Magnetic North. Automatic uses True North whenever a valid declination is available and falls back to Magnetic North otherwise — the effective reference is always shown. |
| 🕋 **Qibla Direction** | Offline, local great-circle bearing to the Kaaba, relative turn guidance (±2° alignment threshold), optional distance, haptics on alignment, fully optional and disabled by default. |
